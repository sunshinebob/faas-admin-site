    ...
    <el-dialog title="二维数据" :visible.sync="diaIsShow" class="diaForm" top="10vh" width="800px">
      <el-form ref="dataForm" :model="formData" :rules="rules" label-width="140px">
        <el-form-item label="地图名称" prop="name">
          <el-input v-model="formData.name" placeholder="请输入地图名称"></el-input>
        </el-form-item>
        <el-form-item label="地图链接" prop="mapUrl">
          <el-input v-model="formData.mapUrl" placeholder="请输入地图链接"></el-input>
        </el-form-item>
        <el-form-item label="含标注">
          <el-switch v-model="formData.hasMark" active-text="是" inactive-text="否"></el-switch>
        </el-form-item>
        <el-form-item label="矢量图链接" prop="markUrl">
          <el-input v-model="formData.markUrl" placeholder="请输入矢量图地址"></el-input>
        </el-form-item>
    ...
    data () {
      return {
        ...
        rules: {
          ...
          mapUrl: [
            { required: true, message: '地图链接不能为空', trigger: 'blur' }
          ],
          markUrl: [
            { required: true, message: '矢量图链接不能为空', trigger: 'blur' }
          ]
        }
      }
    },
