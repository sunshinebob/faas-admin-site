<template>
  <div class="className">
    ...
    <el-dialog title="三维数据" :visible.sync="diaIsShow" class="diaForm" top="10vh" width="800px">
      <el-form ref="dataForm" :model="formData" :rules="rules" label-width="140px">
        ...
        <el-form-item label="模型链接" prop="modelUrl">
          <el-input v-model="formData.modelUrl" placeholder="请输入模型链接"></el-input>
        </el-form-item>
    ...
    data () {
      return {
        ...
        rules: {
          ...
          modelUrl: [
            { required: true, message: '模型链接不能为空', trigger: 'blur' }
          ]
        }
      }
    },
